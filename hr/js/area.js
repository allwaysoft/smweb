...
function change(v, pro, city, cou){
	if (v == 0) {
		var selv = pro;
	} else if (v == 1) {
		var selv = city;
	...
	with(ss){
	  ...
	  if(++v<s.length){change(v, pro, city, cou);}
	}
}

function change2(v, pro, city, cou){
	if (v == 0) {
		var selv = pro;
	} else if (v == 1) {
		var selv = city;
	...
	with(ss){
	  ...
	  if(++v<s2.length){change2(v, pro, city, cou);}
	}
}
...
function setup(pro, city, cou)
{
	...
	for(i=0;i<s.length-1;i++) {
		...
		document.getElementById(s[i]).onchange=new Function("change("+(i+1)+", '"+pro+"', '"+city+"', '"+cou+"')");
	}
change(0, pro, city, cou);
}
//新增
var s2=["province2","city2","county2"];
function setup2(pro, city, cou){
	var v = '';
	for(i=0;i<s2.length-1;i++) {
		...
		document.getElementById(s2[i]).onchange=new Function("change2("+(i+1)+", '"+pro+"', '"+city+"', '"+cou+"')");
	}
change2(0, pro, city, cou);
}