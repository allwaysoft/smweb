 ...
 $('#listTable').dataTable().fnDestroy(); 
  $('#listTable').dataTable( { 
					  ...
					  "fixedHeader": true,
					   "responsive": true,
					 "ajax":{
						  "url": "/semir400admin.php/Staff/get_list/source/terminal",
					  },
...
/////////////////////////
 ...
 function _attend(id,obj){
	 ...
	 $.post('/semir400admin.php/Staff/attend',{id:id,source:'terminal'},function(msg){
		 if(msg.status==false){
  ...
  /////edit  
	function _getinfo(id){  
		BootstrapDialog.show({
            ...
            message: $('<div></div>').load("/semir400admin.php/Staff/terminalinfo/id/"+id) 
        });
	};
 //	 
