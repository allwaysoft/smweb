 ...
 $('#listTable').dataTable().fnDestroy(); 
  $('#listTable').dataTable( { 
					  ...
					  "fixedHeader": true,
					   "responsive": true,
					 "ajax":{
						  "url": "/semir400admin.php/Staff/get_list/source/service",
					  },
...
/////////////////////////
 ...
 function _attend(id,obj){
	 ...
	 $.post('/semir400admin.php/Staff/attend',{id:id,source:'service'},function(msg){
		 if(msg.status==false){
  ...
  /////edit  
	function _getinfo(id){
		BootstrapDialog.show({
            ...
            message: $('<div></div>').load("/semir400admin.php/Staff/serviceinfo/id/"+id) 
        });
