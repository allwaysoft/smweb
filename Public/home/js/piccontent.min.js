$(function() {
	...
	$(".picmidmid ul li").first().addClass("selectpicDiv");
	...
	function nextclick() {
		...
		if (currrentindex != (length - 1)) {
			...
			curli.removeClass("selectpicDiv");
			curnextli.addClass("selectpicDiv");
	...
	getli.click(function() {
		...
		$(".picmidmid ul li[class='selectpicDiv']").removeClass("selectpicDiv");
		var currentli = getli.eq(currentliindex);
		currentli.find("img").addClass("selectpic"); 
		currentli.addClass("selectpicDiv");
	...
	$(".replaybtn2").click(function() {
		...
		$(".detail_picbot_mid ul li").removeClass("selectpicDiv");
		$(".detail_picbot_mid ul li").eq(0).find("img").addClass("selectpic");
		$(".detail_picbot_mid ul li").eq(0).addClass("selectpicDiv");
