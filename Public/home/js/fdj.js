	...
	$(document).ready(function() {
	    ...
	    $("#imageMenu li img").bind("click", function(){
			if ($(this).attr("id") != "onlickImg") {
				midChange($(this).attr("src").replace("S", "B"));
			...
			if($(this).attr("id") != "onlickImg"){
				...
				midChangeHandler = window.setTimeout(function(){
					midChange($("#onlickImg img").attr("src").replace("S", "B"));
				}, 1000);
			}
		});
	    ...
	    function changeViewImg() {
	        $("#bigView img").attr("src", $("#midimg").attr("src").replace("B_", ""));
	    }
	    ...
	    function fixedPosition(e) {
	        ...
	        $("#bigView").css({ "top":49.5, "left":$(".preview").width()+10,"height":510});
