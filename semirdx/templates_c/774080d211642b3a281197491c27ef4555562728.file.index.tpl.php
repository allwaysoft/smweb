<?php /* Smarty version Smarty-3.1.11, created on 2016-07-14 03:38:45
         compiled from "templates\Dxsemir\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:73305760bc2d980ce6-54539300%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '774080d211642b3a281197491c27ef4555562728' => 
    array (
      0 => 'templates\\Dxsemir\\index.tpl',
      1 => 1468460324,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '73305760bc2d980ce6-54539300',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_5760bc2da21075_25392478',
  'variables' => 
  array (
    'web_title' => 0,
    'web_template' => 0,
...
<?php if ($_valid && !is_callable('content_5760bc2da21075_25392478')) {function content_5760bc2da21075_25392478($_smarty_tpl) {?><!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<section class="page_section" id="clients">
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['bannerPics']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['row']->key => $_smarty_tpl->tpl_vars['row']->value){
$_smarty_tpl->tpl_vars['row']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['row']->key;
?>
            <li class="link-li" >
            <?php if ($_smarty_tpl->tpl_vars['row']->value->hType==1){?>
            <a href="<?php echo $_smarty_tpl->tpl_vars['row']->value->hUrl;?>
" title="<?php echo $_smarty_tpl->tpl_vars['row']->value->hTitle;?>
">
            <?php }else{ ?>
            <a href="<?php echo $_smarty_tpl->tpl_vars['row']->value->hUrl;?>
" title="<?php echo $_smarty_tpl->tpl_vars['row']->value->hTitle;?>
"  target="_blank" >
            <?php }?>
              <div class="linkNav"> 
                <div class="img"><img class="imgs" src="/semirdx/attachments/adpic/<?php echo $_smarty_tpl->tpl_vars['row']->value->hPic;?>
" alt="..."></div>
                <!--img-circle-->
                <div class="title"> <?php echo $_smarty_tpl->tpl_vars['row']->value->hTitle;?>
 </div>
                 </div>
                 </a>
            </li>
