...
<div  class="top_box">
  <div class="container">
    <div class="hottel  text-right">Tech Hotline:  0577-85789999 To 1
      &nbsp;&nbsp;&nbsp;&nbsp;
      Tech Support(QQ)：<img  style="CURSOR: pointer" onclick="javascript:window.open('http://b.qq.com/webc.htm?new=0&sid=800086115&o=技术支持&q=7', '_blank', 'height=502, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');"  border="0" SRC=http://wpa.qq.com/pa?p=1:800086115:3 alt="点击这里给我发消息">
      </div>
...
<section class="page_section" id="clients">
  <div class="container">
    <div class="client_logos">
      <div class="list-list">
        <div class="list-left">
          <h2>Apps entrance<span class="lead"> / Links</span></h2>
          <ul class=" linkslist">
