        ...
        fields: {
		 ...
		 var post_data = $("#subForm").serializeArray();
				...
				//alert($("input[name=id]").val());
                    ...
                    post_url = "{%site_url('admin/system/user_edit_pass_do')%}";//"{%site_url('admin/homepage/add')%}";
...
<!-- modal body start -->
        <div class="form-group form-group-sm">
                <label class="col-sm-3 control-label" for="username">Login Name</label>
                 <div class="col-sm-8">
                   <input disabled="disabled" type="text" class="form-control" name="username"  id="username" placeholder="Login name" value="{%$smarty.session.admin%}">
