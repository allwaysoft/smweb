...
<div class="container">
  ...
  <!-- top ----->
  <div class="col-xs-12">
    <h1><i class="fa fa-lightbulb-o" aria-hidden="true"></i> 终端抽检记录</h1>
    <div class="h20"></div>
...
$(document).ready(function(){ 
 ...
 var table = $('#listTable').dataTable( { 
					  ...
					  "fixedHeader": true,
					   "responsive": true,
					 "ajax":{
						  "url": "/semir400admin.php/Service/terminal_get_list/source/terminal",
					  },
					 "order": [[ 0, "desc" ]],
  ...
  $("button[name='outExcel']").click(function() { 
 	    ...
 	    window.location.href = "<?php echo U('service/terminal_excel');?>?"+post_data; //转到另一页面
   }); 
});
/////////////////////////  
	function _getinfo(id){  
		BootstrapDialog.show({
            ...
            message: $('<div></div>').load("/semir400admin.php/Service/terminalinfo/id/"+id) 
        });
	};
 //	 
