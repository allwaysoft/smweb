...
<div class="container">
  ...
  <div class="row">  
   <!-- top ----->
    <div class="col-xs-12">
      <h1><span class="glyphicon glyphicon-eye-open"></span> 投诉管理</h1>
      <div class="h20"></div>
...
$(document).ready(function(){ 
 ...
 var table = $('#listTable').dataTable( { 
					 ...
					 // "fixedHeader": true,
					   "responsive": true,
					 "ajax":{
						  "url": "/semir400admin.php/Service/get_list/source/service", 
					  },
  ...
  $("button[name='outExcel']").click(function() { 
 	    ...
 	    window.location.href = "<?php echo U('service/service_excel');?>?"+post_data; //转到另一页面
   });      
});
///////////////////////// 
  /////info  
	function _getinfo(id){
		BootstrapDialog.show({
            ...
            message: $('<div></div>').load("/semir400admin.php/Service/serviceinfo/id/"+id) 
        });
