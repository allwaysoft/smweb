        ...
        <div class="my-form form-horizontal"> 
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-6">
              ...
              <input name="status" type="radio" id="status" value="1" <?php if($user["status"] == 1): ?>checked="checked"<?php endif; ?> > 启用
            </label>
            <label class="radio-inline">
              <input type="radio" name="status" id="status" value="2" <?php if($user["status"] == 2): ?>checked="checked"<?php endif; ?>> 锁定
            </label> 
