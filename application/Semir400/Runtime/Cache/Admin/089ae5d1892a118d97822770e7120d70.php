		...
		$.each(BootstrapDialog.dialogs, function(id, dialog){
		 ...
		 var post_data = $("#subForm").serializeArray();
				...
				//alert($("input[name=id]").val());
                 post_url = "/semir400admin.php/System/subject_edit_do"; 
      ...
      <form name="subForm" id="subForm"  class="form-horizontal"  method="post"   enctype='multipart/form-data' action="" role="form">
        <div class="my-form form-horizontal"> 
          <!-- modal body start -->
            ...
            <label class="col-sm-3 control-label" for="title">投诉主题</label>
            <div class="col-sm-6 ">
              <input type="text" class="form-control" name="title"  id="title" placeholder="请输入投诉主题" value="<?php echo ($info["title"]); ?>">
               <input type="hidden"   name="id" id="id" placeholder="id" value="<?php echo ($info["id"]); ?>">
            </div>
          </div>
          <!--item --> 
