...
<div class="container">
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="topRightBut pull-right"> <a href="<?php echo U('Index/index');?>" class=" "><i class="fa fa-mail-reply" aria-hidden="true"></i> 返回</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo U('Index/index_apply');?>" class="btn btn-success  btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i> 服务投诉申请</a> </div>
      <h1><span class="glyphicon glyphicon-eye-open"></span> 服务投诉 <small>>> 详细信息</small> </h1>
    </div>
  </div>
  <!-- top ----->
  <div class="h20"></div>
  ...
  <div class="row">
    <div class="col-sm-12"> 
      ...
      <div class="col-sm-10" > 
        <p >投诉编号：<?php echo ($info["com_code"]); ?>&nbsp;&nbsp;&nbsp;&nbsp; <?php echo (date("Y-m-d H:i:s",$info["add_time"])); ?> </p>
   ...
   <!-- <eq name="info.com_status" value="3">-->
    <?php if(!empty($feedback)): ?><div class="col-sm-12" id="track" >
        ...
        <div class="col-sm-10" >
          <?php if(is_array($feedback)): $i = 0; $__LIST__ = $feedback;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><blockquote>
              ...
              <div class="row">
                <footer class="col-sm-10 col-md-offset-2">
                <cite title="Source Title ">客服： <?php echo ($vo["com_user"]); ?> / <?php echo (date("Y-m-d H:i:s",$vo["add_time"])); ?></cite>
                </footer>
              </div>
