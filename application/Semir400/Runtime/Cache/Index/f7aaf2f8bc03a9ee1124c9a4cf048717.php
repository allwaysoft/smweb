...
<div id="msgShow"></div>
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <a href="<?php echo U('Index/quality_apply');?>" class="btn btn-success  "><i class="fa fa-plus-circle" aria-hidden="true"></i> 质量投诉申请</a>  
      </div>
      <h1><i class="fa fa-bell-o" aria-hidden="true"></i> 质量投诉</h1>
    </div>
  </div>
  <!-- top ----->
  <div class="h20"></div>
...
<script type="text/javascript" src="<?php echo RES;?>/Index/js/quality.js"></script>
 <!-- footer -->
   <div class="h20"></div>
<footer>
 <div class="container">
