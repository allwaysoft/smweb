...
<div id="msgShow"></div>
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <a href="<?php echo U('Index/sampling_apply');?>" class="btn btn-success "><i class="fa fa-plus-circle" aria-hidden="true"></i> 终端抽检申请</a> 
       <!--  <a href="javascript:;" class="btn btn-info  btn-sm uploanStatus"><span class="glyphicon glyphicon-refresh"></span> 更新所有状态</a> --> 
      </div>
      <h1><i class="fa fa-lightbulb-o" aria-hidden="true"></i> 终端抽检</h1>
    </div>
  </div>
  <!-- top ----->
  <div class="h20"></div>
        ...
        <table  id="listTable" class="table table-striped table-bordered "  cellspacing="0" width="100%">
          <thead>
            <tr>
              ...
              <th>抽检编号 <span class="sr-only"></span></th>
...
<script type="text/javascript" src="<?php echo RES;?>/Index/js/sampling.js"></script>
 <!-- footer -->
   <div class="h20"></div>
<footer>
 <div class="container">
