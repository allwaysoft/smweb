...
<div id="msgShow"></div>
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <h1><span class="glyphicon glyphicon-eye-open"></span> 贷款管理 <small>>> 特殊贷款申请</small>  </h1>
    </div>
  </div>
  <!-- top ----->
  <div class="h20"></div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <form name="subForm" id="subForm"  class="form-horizontal"  method="post"   enctype='multipart/form-data' action="<?php echo U('Register/reg_add_do/t/S');?>" role="form">
      <input type="hidden" name="TOKEN" value="<?php echo session('TOKEN');?>"> 
        <div class="my-form form-horizontal"> 
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-4">
              <p class="form-control-static rightFont"> 特殊贷款 </p>
              <input type="hidden" class="form-control" name="type"  id="type" placeholder="type" value="S">
