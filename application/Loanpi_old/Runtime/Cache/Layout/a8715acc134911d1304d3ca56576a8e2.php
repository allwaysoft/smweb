      ...
      <form name="subForm" id="subForm"  class="form-horizontal"  method="post"   enctype='multipart/form-data' action="" role="form">
        <div class="my-form form-horizontal"> 
          ...
          <div class="form-group form-group-sm">
            ...
            <?php if($type == 'N'): ?>日常贷款<?php endif; ?>
            <?php if($type == 'S'): ?>特殊贷款<?php endif; ?>
            </p>
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-4">
              <p class="form-control-static rightFont">  <?php echo ($reg_start_time); ?></p>
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-4">
             <a href="<?php echo U('Register/reg_start/t/N');?>" class="btn  btn-info btn-sm"><span class='glyphicon glyphicon-chevron-left'></span> 上一步</a>  
