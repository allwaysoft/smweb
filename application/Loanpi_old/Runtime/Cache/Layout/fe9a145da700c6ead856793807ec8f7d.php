  ...
  <nav class="navbar navbar-inverse  navbar-fixed-top">
    <div class="container"> 
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"><img src="/<?php echo c('VIEW_PATH');?>Loanpi/Layout/images/logow.png" width="120px"  alt="贷款申请管理"/></a> </div>
...
<div id="msgShow"></div>
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <a href="<?php echo U('Register/reg_special_start/t/S');?>" class="btn btn-success  btn-sm">特殊贷款申请</a> 
      </div>
      <h1><span class="glyphicon glyphicon-eye-open"></span> 特殊贷款 </h1>
    </div>
  </div>
  <!-- top ----->
  <div class="h20"></div>
    ...
    <div class="col-xs-12">
      <form action="" method=" ">
        <table  id="listTable" class="table table-striped table-bordered "  cellspacing="0" width="100%">
          <thead>
            <tr>
              <th width="15%">提交日期 <span class="sr-only"></span></th>
              <th>申请天数 <span class="sr-only">申请天数</span></th>
              <th>申请金额(元)<span class="sr-only">金额(元)</span></th>
              <th>申请日期<span class="sr-only">申请开始</span></th>
              <th>申请状态<span class="sr-only">状态</span></th>
              <th>SAP编号<span class="sr-only">SAP单号</span></th>
              <th>贷款周期(天)<span class="sr-only">贷款周期(天)</span></th>
              <th>起始日<span class="sr-only">起始日</span></th> 
              <th>到期日<span class="sr-only">到期</span></th>
              <th>还款操作<span class="sr-only">还款</span></th>  
            </tr>
          </thead>
        </table>
      </form>
...
<script type="text/javascript" src="/<?php echo c('VIEW_PATH');?>Loanpi/Layout/js/special.js"></script> 
 <!-- footer -->
   <div class="h20"></div>
<footer>
 <div class="container">
