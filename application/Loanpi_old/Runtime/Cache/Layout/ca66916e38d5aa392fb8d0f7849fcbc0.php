...
<script type="text/javascript">
	...
	////
     $('#subForm').bootstrapValidator({
        ...
        fields: {
            rep_amount: {
                ...
                validators: {
					...
					number: { message:  ' 金额必须为数字'},
                    greaterThan: {
                        value: 1, message:  ' 还款金额大于1元'
                    },
                    lessThan: {
	  ...
	  ////////////// 
	 <?php if($jsVail == 0 ): ?>$.each(BootstrapDialog.dialogs, function(id, dialog){
					 dialog.close();
				 });
	  BootstrapDialog.show({
								type:"type-danger",
        ...
        <div class="my-form form-horizontal"> 
          ...
          <div class="form-group form-group-sm">
            ...
            <p  class="form-control-static">
             ...
             <p  class="form-control-static">贷款金额: <?php echo ($loan['reg_amount']); ?> 元, 已经还款: <?php echo ($repTotal); ?> 元, 需还: <?php echo ($loan['reg_amount']-$repTotal); ?> 元</p>
            </div>
          </div>
           <!--item -->
              <!--item -->
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-9">
              <p  class="form-control-static"><?php echo ($sapBalance); ?> 元</p> 
            </div>
          ...
          <!--item -->
          <div class="form-group form-group-sm">
            <label class="col-sm-3 control-label" for="rep_amount">本次还款金额</label>
            <div class="col-sm-4">
