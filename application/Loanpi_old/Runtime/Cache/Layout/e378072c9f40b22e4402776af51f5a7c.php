<?php if (!defined('THINK_PATH')) exit();?> 
  ...
  <!-- top -----> 
  <div class="">
  贷款编号:<?php echo ($reginfo['sap_code']); ?>, 贷款：<?php echo ($reginfo['reg_amount']); ?>元 / <?php echo ($reginfo['sap_cycle']); ?>天 / <?php echo ($reginfo['sap_start_time']); ?>~<?php echo ($reginfo['sap_end_time']); ?>
  </div>
  <hr />
  <!-- main ----->
        ...
        <table  id="listTable" class="table table-condensed table-hover table-striped table-bordered "  cellspacing="0" >
          <thead>
            <tr>
              ...
              <th width="27%">还款金额(元)<span class="sr-only">还款金额(元)</span></th>  
