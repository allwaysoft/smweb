...
<div id="msgShow"></div>
  ...
  <div class="row">
    <div class="col-xs-12"> 
      <h1><i class="fa fa-history" aria-hidden="true"></i> 历史数据 </h1>
    </div>
  </div>
  <!-- top ----->
  <div class="h20"></div>
    ...
    <div class="col-xs-12">
      <form action="" method=" ">
        <table  id="listTable" class="table table-striped table-bordered "  cellspacing="0" width="100%">
          <thead>
            <tr>
              <th width="15%">申请日期 <span class="sr-only"></span></th>
              <th>申请天数 <span class="sr-only">申请天数</span></th>
              <th>金额(元)<span class="sr-only">金额(元</span></th>
              <th>贷款日期<span class="sr-only">申请开始</span></th>
              ...
              <th>还款<span class="sr-only">还款</span></th>  
            </tr>
          </thead>
        </table>
      </form>
...
<script type="text/javascript" src="/<?php echo c('VIEW_PATH');?>Loanpi/Layout/js/registerhistory.js"></script> 
 <!-- footer -->
   <div class="h20"></div>
<footer>
 <div class="container">
