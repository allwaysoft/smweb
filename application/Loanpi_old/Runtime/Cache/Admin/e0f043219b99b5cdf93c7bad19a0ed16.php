...
<div class="container"> 
  ...
  <div class="row">
    <div class="col-xs-12">
      <h1><i class="fa fa-history" aria-hidden="true"></i> 还款记录 </h1>
    </div>
  </div>
  <!-- top ----->
  <div class="h20"></div>
        ...
        <table  id="listTable" class="table table-striped table-bordered "  cellspacing="0" width="100%">
          <thead>
            <tr>
              ...
              <th>代理商编号<span class="sr-only">代理商编号</span></th>
              <th>贷款SAP单号<span class="sr-only">SAP单号</span></th>
              <th>还款SAP单号<span class="sr-only">还款单号</span></th>  
              <th>还款金额(元)<span class="sr-only">还款金额(元)</span></th>  
	  ...
	  $('#listTable').dataTable().fnDestroy(); 
			 $('#listTable').dataTable( { 
					  ...
					  "fixedHeader": true,
					   "responsive": true,
					 "ajax":{
						  "url": "/loanpiadmin.php/Index/repayment_list",
					  },
					 "order": [[ 0, "desc" ]],
					 "columns": [
							{"data": "rep_date"},
