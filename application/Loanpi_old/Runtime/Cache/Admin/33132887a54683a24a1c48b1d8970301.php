  ...
  <nav class="navbar navbar-inverse  navbar-fixed-top">
    <div class="container"> 
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Login <!--<img src="/<?php echo c('VIEW_PATH');?>Loanpi/Layout/images/logow.png" width="120px"  alt="森马"/>--></a> </div>
      
      <!-- Collect the nav links, forms, and other content for toggling -->
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
         <li 
          <?php if($url == 'Index'): ?>class='active'<?php endif; ?>
          ><a href="<?php echo U('Index/index');?>" >Index</a>
          </li>
          <li 
          <?php if($url == 'Register'): ?>class='active'<?php endif; ?>
          ><a href="<?php echo U('Index/register');?>" >Register</a>
          </li>
          <li class="dropdown <?php if($url == 'Repayment'): ?>active<?php endif; ?>
            " > <a href="<?php echo U('Index/repayment');?>" >Repayment </a>
          </li>
          <li 
          <?php if($url == 'History'): ?>class='active'<?php endif; ?>
          ><a href="<?php echo U('History/index');?>">Log</a>
          </li> 
          ...
          <li >
          <a href="<?php echo U('Login/loginout');?>"><i class="fa fa-lock" aria-hidden="true"></i> Logout</a>
          </li>
        </ul>
      </div>
      <!-- /.navbar-collapse --> 
...
<div id="msgShow"></div>
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <h1><span class="glyphicon glyphicon-eye-open"></span> Register </h1>
    </div>
  </div>
  <!-- top ----->
  <div class="h20"></div>
    ...
    <div class="col-xs-12">
      <form action="" method=" ">
        <table  id="listTable" class="table table-striped table-bordered "  cellspacing="0" width="100%">
          <thead>
            <tr>
              <th width="15%">RegDate <span class="sr-only"></span></th>
              <th>RegCycle(D) <span class="sr-only">申请天数</span></th>
              <th>Amount(RMB)<span class="sr-only">金额(元</span></th>
              ...
              <th>Repay<span class="sr-only">还款</span></th>  
            </tr>
          </thead>
        </table>
      </form>
...
<script type="text/javascript" src="/<?php echo c('VIEW_PATH');?>Loanpi/Admin/js/index.js"></script> 
 <!-- footer -->
   <div class="h20"></div>
<footer>
 <div class="container">
