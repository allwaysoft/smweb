...
class ServiceController extends Controller {
    ...
    public function UpStatementToLocal() {
		...
		//*/
        $res['val'] = 1;
        $res['msg'] = json_encode($item); //;
        // print_r($res);
        echo json_encode($res);
    }
function is_arrayd($array){
			 $s = 1;//默认为1为数组
...
//print_r(get_object_vars($array));
    ...
    public function UpStatementTestaaaaaaa() {
        ...
        $data['item'][] = array('ID' => '2', 'AGENT_CODE' => '22DG1', 'AGENT_KPF' => '0000000008', 'NAME1' => 'S', 'LOAN_TYPE' => 'S', 'DKCR' => '5', 'OTAP' => 'Ssss', 'OTCR' => '20160505', 'LOAN_DATE_TO' => '20160909', 'LOAN_CYCLE' => '30', 'LOAN_AMOUNT' => '10000', 'YL1' => '', 'YL2' => '', 'YL3' => '', 'YL4' => '', 'YL5' => '');
