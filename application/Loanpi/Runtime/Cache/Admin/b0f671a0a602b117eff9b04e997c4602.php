...
<div class="container"> 
  ...
  <div class="row">
    <div class="col-xs-12">
       <h1><i class="fa fa-info-circle" aria-hidden="true"></i> 对账日志 </h1>
    </div>
  </div>
  <!-- top ----->
  <div class="h20"></div>
	  ...
	  $('#listTable').dataTable().fnDestroy(); 
			 $('#listTable').dataTable( { 
					  ...
					  "fixedHeader": true,
					   "responsive": true,
					 "ajax":{
						  "url": "/loanpiadmin.php/Index/statement_log_list",
					  },
					 "order": [[ 0, "desc" ]],
					 "columns": [
							{"data": "update"},
					...
					"fnRowCallback":function(nRow,aData,iDataIndex){
						$('td:eq(0)',nRow).addClass("tableDate");
						 $('td:eq(-1)',nRow).html("<a class='btn btn-info btn-xs' href=/loanpiadmin.php/Index/statement_log_row/id/"+aData.id+"   type='button' name='viewMapp'>详细</a>");
						//return nRow;
					},
          		 "deferRender": true
			   });
