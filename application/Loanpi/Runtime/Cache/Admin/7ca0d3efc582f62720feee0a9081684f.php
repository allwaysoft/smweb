...
<div id="msgShow"></div>
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <h1><span class="glyphicon glyphicon-eye-open"></span> 贷款记录</h1>
    </div>
  </div>
  <!-- top ----->
  <div class="h20"></div>
...
<script type="text/javascript" src="/<?php echo c('VIEW_PATH');?>Loanpi/Admin/js/register.js"></script> 
 <!-- footer -->
   <div class="h20"></div>
<footer>
 <div class="container">
