  ...
  <div class="row">
    <div class="col-xs-12">
     <div class="topRightBut pull-right">
        <button type="button" name="addBut" class="btn btn-success  btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i> 添加新用户</button>
      </div>
      <h1><i class="fa fa-users" aria-hidden="true"></i> 用户管理 </h1>
    </div>
  </div>
  <!-- top ----->
  <div class="h20"></div>
    ...
    <div class="col-xs-12">
      <form action="" method=" ">
        <table  id="listTable" class="table table-striped table-bordered "  cellspacing="0" width="100%">
          <thead>
            <tr>
            <th>时间<span class="sr-only">建立</span></th>  
...
<!--  container  --> 
<script type="text/javascript" src="/<?php echo c('VIEW_PATH');?>Loanpi/Admin/js/user.js"></script> 
