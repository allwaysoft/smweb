...
<div class="container" id="printShow">  
  ...
  <div class="row">
    <div class="col-xs-12"> 
      <h3 class="text-center">森马往来账项核对函</h3>
    </div>
     <div class="col-xs-12"> 
      <!--  ----->
      <p class="top">
      ...
      致：<?php echo ($data['agent_name']); ?>
	   ...
	   <p class="info">
     下列信息出自本公司新分销系统往来账概况，如与贵公司记录相符，请在本函下端"信息证明无误" 处签章证明；如有不符，请在"信息不符"处列明不符项目。如存在与本公司有关的未列入本函的其他项 目，请在"信息不符"处列出这些项目的金额及详细资料。回函请寄至森马市场链各大区对应销售经理处 ，地址：上海市闵行区莲花南路2689号
