...
<div id="content" class="white">
  <div class="mbxie"><a href="" class="first_a" ><img src="/Public/admin/images/back.jpg" width="25" height="12" />返回上一页</a><img src="/Public/admin/images/home1.jpg" width="20" height="12" /><a href="<?php echo U('Admin/Main/main');?>"  style=" padding-left:3px;">首页</a>><a href="javascript:void(0)">管理员设置</a>><a href="<?php echo U('Adm/admindex');?>">管理员列表</a></div>
  <div class="bloc">
    <div class="wrap ">
    <form action="" method="get" id="searchForm">
      ...
      <form method="post" action="<?php echo U('Adm/admdel');?>" id="form1">
      <dl class="dl_line">
      ...
      <div class="content">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd">
            ...
            <td><a href="<?php echo U('Adm/admedit',array('id'=>$vo['id']));?>">修改</a>
            	<?php if(($vo["id"]) != "1"): ?><a id="no<?php echo ($vo["id"]); ?>" href="javascript:void(0)" onclick="ResetPwd(<?php echo ($vo["id"]); ?>)">密码重置</a>
            	<a href="<?php echo U('Adm/admdel',array('id'=>$vo['id']));?>">删除</a><?php endif; ?>
            </td>
