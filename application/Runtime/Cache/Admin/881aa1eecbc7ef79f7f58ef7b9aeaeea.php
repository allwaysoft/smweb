    ...
    <div class="content">
		<table id="alist" border="0" cellpadding="0" cellspacing="0" width="100%" class="list" style="float:left" >  
			...
			<?php if($sub != null): ?><tr>
			  	<td>Banner设置</td>
				<td>
				<?php if($sub['type'] == 'pic'): ?>图片
				<?php elseif($sub['type'] == 'text'): ?>
				文字
				<?php else: ?>
				图片+文字<?php endif; ?>
				</td>
				...
				<td class="actions" style="text-align:center; margin-left:10px;"><a href = "<?php echo U('Admin/HotSales/bannerEdit',array('id'=>$vo['id']));?>" >修改</a> </td>
			 </tr><?php endif; ?>
			</tbody>
		</table>
	</div>
