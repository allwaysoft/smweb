...
<body>
<script type="text/javascript" src="/Public/admin/js/jquery.dragsort-0.5.1.min.js"></script>
<!--   CONTENT  ---->
<div id="content" class="white">
<div class="mbxie"><a href="" class="first_a" ><img src="/Public/admin/images/back.jpg" width="25" height="12" />返回上一页</a><img src="/Public/admin/images/home1.jpg" width="20" height="12" /><a href="<?php echo U('Admin/Main/main');?>"  style=" padding-left:3px;">首页</a>><a href="javascript:void(0)">新闻管理</a>><a href="index">新闻列表</a>><a href="add">添加新闻</a></div>
<div class="bloc">
  <div class="wrap ">
  </div>
</div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <select select id="type_id" name="type_id" class="valid">
              ...
              <?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php $__FOR_START_701__=1;$__FOR_END_701__=$vo['level'];for($i=$__FOR_START_701__;$i < $__FOR_END_701__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;<?php } ?>﹄ <?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
			</td>
        </tr>
        ...
        <tr>
          ...
          <td width="223"><input name="time" id="time" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  class="input" value="<?php echo (date("Y-m-d H:i:s",$time)); ?>"></td>
          <td width="96">截止日期：<font class="red">*</font></td>
          <td width="631"><input name="endtime" id="endtime" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  class="input" value="<?php echo (date("Y-m-d H:i:s",$endtime)); ?>"></td>
        </tr>
        <tr>
          <th>作者：</th>
