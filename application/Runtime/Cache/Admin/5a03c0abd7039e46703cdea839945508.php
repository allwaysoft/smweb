...
<div class="mbxie"><a href="" class="first_a" ><img src="/Public/admin/images/back.jpg" width="25" height="12" />返回上一页</a><img src="/Public/admin/images/home1.jpg" width="20" height="12" /><a href="<?php echo U('Admin/Main/main');?>"  style=" padding-left:3px;">首页</a>><a href="javascript:void(0)">商品管理</a>>
  	<a href="<?php echo U('Quota/index');?>">配额管理</a>><a href="<?php echo U('Quota/import',array('areaname'=>$areaname));?>">导入</a></div>
<div class="bloc">
  <div class="wrap ">
...
<div class="wrap">
  ...
  <input type="hidden" name="areaname" value="<?php echo ($areaname); ?>" />
    <table class="add">
      <tbody>
      	<tr>
      		<th>导入模板：</th>
      		<td><img alt="" src="/Public/admin/images/execl.png"/><a href="/Public/admin/UploadModel/peinto.xls">配额导入模板下载</a></td>
      	</tr>
      	<tr>
          <th>导入日期：<font class="red">*</font></th>
          <td><input name="quotatime" id="quotatime" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  class="input" value="<?php echo (date("Y-m-d",$quotatime)); ?>"></td>
        </tr>
        <tr>
        	<th>标题：</th>
        ...
        <tr><th></th><td><input id="loaddata" class="btnGray" type="submit" value="导入数据"/></td></tr>
      </tbody>
    </table>
  </form>
</div>
