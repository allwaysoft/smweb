...
<div id="content" class="white">
 <div class="mbxie"><a href="" class="first_a" ><img src="/Public/admin/images/back.jpg" width="25" height="12" />返回上一页</a><img src="/Public/admin/images/home1.jpg" width="20" height="12" /><a href="<?php echo U('Admin/Main/main');?>"  style=" padding-left:3px;">首页</a>><a href="javascript:void(0)">店铺管理</a>><a href="type">店铺分区</a></div>
<div class="bloc">
  <div class="wrap ">
      <dl class="dl_line">
    ...
    <tr> 
      ...
      <th style="width:200px;">操作</th> 
        ...
        <?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php echo ($vo["pid"]); ?>" id="<?php echo ($vo["pid"]); ?>_<?php echo ($vo["id"]); ?>"> 
		      ...
		      <?php $__FOR_START_9073__=1;$__FOR_END_9073__=$vo['level'];for($i=$__FOR_START_9073__;$i < $__FOR_END_9073__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;<?php } ?>
		      ...
		      <a href="<?php echo U('Gallery/typeedit',array('id'=>$vo['id']));?>" class="edit">修改</a>
		      <a href="<?php echo U('Gallery/typedel',array('id'=>$vo['id']));?>" onclick="return confirm('确定删除吗？')" class="delete">删除</a>
		      </td> 
