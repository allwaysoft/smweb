...
<form action="" method="get">
  <dl class="dl_line">
    <dd >
      ...
      <input type="text" name="keyword" id="keyword" value="<?php echo ($keyword); ?>" onfocus="this.value='';"  />
      <input type="submit" id="btnSearch" value=" 搜 索 " />
    </dd>
  </dl>
 </form>
 <form action="<?php echo U('LocalUser/LocalUserdel');?>" method="post">
  <dl class="dl_line">
           ...
           <td><?php echo ($i); ?></td>
            <td><?php echo ($vo["user_name"]); ?></td>
             <td><?php echo ($vo["name"]); ?></td>
              ...
              <td><?php echo ($vo["area1"]); ?></td>
              <td><?php echo ($vo["area2"]); ?></td>
              ...
              <td><a href="<?php echo U('LocalUser/logs',array('id'=>$vo['id']));?>">查看</a><a href="<?php echo U('LocalUser/LocalUseredit',array('id'=>$vo['id']));?>" style="margin:0px 10px;">编辑</a><a  style="padding-left:10px;" href="<?php echo U('LocalUser/LocalUserdel',array('id'=>$vo['id']));?>">删除</a><a id="no<?php echo ($vo["id"]); ?>" style="padding-left:10px;" href="javascript:voil(0)" onclick="ResetPwd(<?php echo ($vo["id"]); ?>)">密码重置</a></td>
...
function ResetPwd(obj){
	$.ajax({
		type:"get",
		url :"<?php echo U('LocalUser/resetPwd');?>",
		data:{id:obj},
		beforeSend :function(){
