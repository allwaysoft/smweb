...
<div id="content" class="white">
  <div class="mbxie"><a href="" style="padding-left:0px;"><img src="/Public/admin/images/back.jpg" width="25" height="12" />返回上一页</a><img src="/Public/admin/images/home1.jpg" width="20" height="12" /><a href="<?php echo U('Admin/Main/main');?>">首页</a>><a href="javascript:void(0)">管理员设置</a>><a href="">管理员添加</a></div>
  <div class="bloc">
 <dl  class="t_1_h">
      ...
      <table class="add">
        <tbody>
          <tr>
            ...
            <td><input name="user_id" maxlength="20" class="input" id="user_id" style="width:200px;" type="text"/>
              <span> 登录用户名不能重复</span> </td>
          </tr>
          <tr>
            <th>登录密码：<font class="red">*</font></th>
            <td><input name="upwd" maxlength="20" class="input" id="password" style="width:200px;" type="password"/>
              <span> 5~20个字符</span> </td>
          </tr>
          <tr>
            <th>确认登录密码：<font class="red">*</font></th>
            <td><input name="confirmpassword" maxlength="20" class="input" id="confirmpassword" style="width:200px;" type="password"/>
            </td>
          </tr>
          <tr>
            <th>姓名：<font class="red">*</font></th>
            <td><input name="username" maxlength="20" class="input" id="username" style="width:200px;" type="text"/>
            </td>
          </tr>
          <tr>
            <th>邮箱：<font class="red">*</font></th>
            <td><input name="email" maxlength="50" class="input" id="email" style="width:200px;" type="text"/>
