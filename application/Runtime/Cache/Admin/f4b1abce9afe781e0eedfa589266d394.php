...
<div id="content" class="white">
  <div class="mbxie"><a href="" class="first_a" ><img src="/Public/admin/images/back.jpg" width="25" height="12" />返回上一页</a><img src="/Public/admin/images/home1.jpg" width="20" height="12" /><a href="<?php echo U('Admin/Main/main');?>"  style=" padding-left:3px;">首页</a>><a href="javascript:void(0)">新闻管理</a>><a href="<?php echo U('News/index');?>">新闻列表</a></div>
  <div class="bloc"> 
    <div class="wrap ">
    <form action="" method="get" id="searchForm">
        ...
        <dd style="width:500px; float:right; margin-top:10px;  ">
          <select id="type_id" name="type_id" style="display:inline-block;">
            <option value="">﹄ 请选择...</option>
              <?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php $__FOR_START_29743__=1;$__FOR_END_29743__=$vo['level'];for($i=$__FOR_START_29743__;$i < $__FOR_END_29743__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;<?php } ?>﹄ <?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
          </select>
          <input type="text" name="keyword" id="keyword" value="<?php echo ($keyword); ?>" title="根据根据文章名称和编号搜索" onfocus="this.value='';" style="width:150px; display:inline-block;"  />
      ...
      <dl class="dl_line">
        <dt><a href="<?php echo U('News/add');?>" class="xz">新增</a>
        <a href="<?php echo U('News/import');?>" class="save">导入</a>
      ...
      <div class="content">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo ($vo["edituser"]); ?></td>
            <td><?php echo (date("Y-m-d H:i:s",$vo["time"])); ?></td>
            <td><?php echo (date("Y-m-d H:i:s",$vo["endtime"])); ?></td>
            <td><a href="<?php echo U('News/edit',array('id'=>$vo['id']));?>" class="edit">修改</a><a href="<?php echo U('News/del',array('id'=>$vo['id']));?>" class="edit">删除</a></td>
