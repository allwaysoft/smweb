...
<form action="" method="get">
  ...
  <form action="<?php echo U('DomainUser/DomainUserdel');?>" method="post">
  <dl class="dl_line">
    ...
    <table class="list">
      ...
      <tbody>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><a href="<?php echo U('DomainUser/logs',array('id'=>$vo['id']));?>">查看</a><a href="<?php echo U('DomainUser/DomainUseredit',array('id'=>$vo['id']));?>" style="margin:0px 10px;">编辑</a><a  style="padding-left:10px;" href="<?php echo U('DomainUser/DomainUserdel',array('id'=>$vo['id']));?>">删除</a></td>
