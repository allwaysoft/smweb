    ...
    <table class="add">
      <tbody>
        <tr>
          ...
          <td><input name="name" maxlength="100" type="text" class="input" id="title" style="width:400px;" value="<?php echo ($infos["name"]); ?>"></td>
        </tr>
        <tr>
          ...
          <td>
            <select select id="type_id" name="type_id" class="valid">
			  ...
			  <option value="1" <?php if($infos["type_id"] == 1): ?>selected="selected"<?php endif; ?>>﹄ 顶部</option>
			  <option value="2" <?php if($infos["type_id"] == 2): ?>selected="selected"<?php endif; ?>>﹄ 底部</option>
			  <option value="3" <?php if($infos["type_id"] == 3): ?>selected="selected"<?php endif; ?>>﹄ 右侧</option>
			  <option value="4" <?php if($infos["type_id"] == 4): ?>selected="selected"<?php endif; ?>>﹄ 实用工具</option>
		    </select>
		  </td>
        </tr>
        <tr id="small_img"> 
        ...
        <tr>
          <th>显示方式：</th>
          <td><input name="ispic" type="radio" value="1" <?php if($infos["ispic"] == 1): ?>checked="checked"<?php endif; ?>>图片&nbsp;&nbsp;<input name="ispic" type="radio" <?php if($infos["ispic"] == 0): ?>checked="checked"<?php endif; ?> value="0">文字</td>
        </tr>
        <tr>
          <th>链接方式：</th>
          <td><input name="isin" type="radio" value="1" <?php if($infos["isin"] == 1): ?>checked="checked"<?php endif; ?>>站内&nbsp;&nbsp;<input name="isin" type="radio" <?php if($infos["isin"] == 0): ?>checked="checked"<?php endif; ?> value="0">站外</td>
        </tr>
        <tr>
          <th>区域筛选：</th>
          <td><input name="isarea" type="radio" value="0" <?php if($infos["isarea"] == 0): ?>checked="checked"<?php endif; ?>>否&nbsp;&nbsp;<input name="isarea" type="radio" value="1" <?php if($infos["isarea"] == 1): ?>checked="checked"<?php endif; ?>>是</td>
        </tr>
        <tr>
          <th>链接地址：</th>
          <td><input name="url" maxlength="100" type="text" class="input" id="title" style="width:400px;" value="<?php echo ($infos["url"]); ?>"></td>
        </tr>
        <tr>
        ...
        <tr>
          <th>前台隐藏：</th>
          <td><input name="display" type="radio" value="0" <?php if($infos["display"] == 0): ?>checked="checked"<?php endif; ?>>否&nbsp;&nbsp;<input name="display" type="radio" value="1" <?php if($infos["display"] == 1): ?>checked="checked"<?php endif; ?>>是</td>
        </tr>
