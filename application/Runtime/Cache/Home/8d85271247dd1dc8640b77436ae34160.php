...
<body class="i_body">
    <div style="height:100%;">
        <div class="section p1" style="height:100%">
            <div class="layout topbg active" style="height:12% !important;">
            ...
            <div class=" main">
                <ul>
                    ...
                    <li class="li_content">
                    	<a href="<?php echo U('company');?>">
                        <div class="div_c_r">
                        	<div class="font_new f_left">
                                <span>公司介绍</span>
                                <span>Company introduction</span>
                            </div>
                        	<div class="img_right">
                            	<img src="/Public/home/newstaff/images/right.png"/>
                            </div>
                        </div>
                        </a>
                    </li>
                    ...
                    <li class="li_content">
                    	<a href="<?php echo U('article',array('Title'=>'入职须知'));?>">
                    	<div class="img_left">
							<img src="/Public/home/newstaff/images/left.png"/>
						</div>
                        <div class="font_new f_right">
							<span>入职须知</span>
